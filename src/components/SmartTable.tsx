...
const EditableCell = ({
    ...
    if (["KeywordCount", "AuthorCount", "YearCount", "SourceCount"].indexOf(id) !== -1) {
        ...
        return <div className="p-td" style={{
            color: val > 0.8 ? "white" : "black",
...
function Table({
    ...
    // Function to handle scrolling and trigger loadMoreData if provided
    ...
    return (
        <Styles>
            <Table
                ...
                loadMoreData={loadMoreData} // Add loadMoreData prop here
            />
        </Styles>
    )
});
